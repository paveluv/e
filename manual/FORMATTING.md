...
`edit:indent-region!` and `edit:indent-buffer!` process lines from top to bottom as one
...
`edit:format-region!` and `edit:format-buffer!` perform indentation and also:
