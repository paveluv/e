;; chez-sigs.e -- parameter names for common builtins, for M-x signatures.
;;
;; An e extension module (see ~/.e).  Compiled builtins carry no source,
...
;; a parenthesized parameter is optional, ... allows any more.
