...
;;
;; An e extension module (see ~/.e).  Markdown is line-oriented, which
;; suits the editor's per-line styles contract: headings, blockquotes,
;; list bullets, fences, and rules are recognized from the line start,
;; then code spans, bold, italics, and links inline.  Fenced code block
