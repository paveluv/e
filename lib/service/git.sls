...
(elibrary (service git)
  (export (rename (git-branch-ahead branch-ahead)) (rename (git-branch-behind branch-behind))
          (rename (git-branch-current? branch-current?)) (rename (git-branch-hash branch-hash))
          (rename (git-branch-name branch-name)) (rename (git-branch-upstream branch-upstream))
          (rename (git-branch? branch?)) (rename (git-branches branches))
          (rename (git-commit-author-email commit-author-email))
          (rename (git-commit-author-name commit-author-name))
          (rename (git-commit-body commit-body)) (rename (git-commit-files commit-files))
          (rename (git-commit-hash commit-hash)) (rename (git-commit-parents commit-parents))
          (rename (git-commit-subject commit-subject)) (rename (git-commit-time commit-time))
          (rename (git-commit? commit?)) (rename (git-current-branch current-branch))
          (rename (git-diff diff)) (rename (git-diff-entry? diff-entry?))
          (rename (git-diff-original-path diff-original-path))
          (rename (git-diff-path diff-path)) (rename (git-diff-status diff-status))
          (rename (git-error-code error-code)) (rename (git-error-command error-command))
          (rename (git-error-stderr error-stderr)) (rename (git-error? error?))
          (rename (git-file-patch file-patch)) init! (rename (git-log log))
          (rename (git-open open)) (rename (git-patch-commit patch-commit))
          (rename (git-patch-line-kind patch-line-kind))
          (rename (git-patch-line-text patch-line-text)) (rename (git-patch-line? patch-line?))
          (rename (git-patch-lines patch-lines)) (rename (git-patch-path patch-path))
          (rename (git-patch? patch?)) (rename (git-repository-path repository-path))
          (rename (git-repository? repository?)) (rename (git-status status))
          (rename (git-status-entry? status-entry?)) (rename (git-status-index status-index))
          (rename (git-status-original-path status-original-path))
          (rename (git-status-path status-path)) (rename (git-status-worktree status-worktree)))
  (import (chezscheme)
