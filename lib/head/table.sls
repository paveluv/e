...
(library (table)
  ...
  (import (chezscheme) (only (edoc) edefine edefine-record-type edoc) (prefix (glyph) glyph:) (prefix (string) string:))

  (edefine-record-type (table make table?)
  ...
  (edefine (cycle-sort keys column)
  ...
  (edefine (heading table keys column)
  ...
  (edefine (less? keys value fallback a b)
  ...
  (edefine (layout table keys all cell width)
